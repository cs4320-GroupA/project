<?php 
    class Course_model extends CI_Model{
        ...
        public function getCourses($semester) {
            $sql = 'SELECT * FROM tasub.course INNER JOIN tasub.user ON tasub.course.instructor_id = tasub.user.user_id WHERE semester = ? ORDER BY tasub.course.course_name';
	...
	*/	
     ...
     */
        public function getPreferenceByInstructor($instruct_Id){
            $q = 'SELECT * FROM tasub.course_preference INNER JOIN tasub.course ON tasub.course_preference.course_id = tasub.course.course_id WHERE tasub.course.instructor_id = ? ORDER BY tasub.course_preference.preference_number';
     ...
     */
        public function getPreferenceByCourse( $course_Id ){
            $q = 'SELECT * FROM tasub.course_preference INNER JOIN tasub.form ON tasub.form.form_id = tasub.course_preference.form_id INNER JOIN tasub.form_data ON tasub.form_data.form_data_id = tasub.form.form_data WHERE tasub.course_preference.course_id = ? ORDER BY tasub.course_preference.preference_number';     
