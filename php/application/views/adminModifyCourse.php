			  ...
			  <?php
  				    foreach($courses as $row){
						echo '<tr>';
		         		...
		         		echo '<form>';
						echo '<button type="submit" class="btn btn-primary" formaction="'.base_url().'index.php/adminEditCourseController/index/'.$row->course_id.'/'.$row->instructor_id.'/'.$row->course_name.'/'">Edit</button> ';
