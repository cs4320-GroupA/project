                 ...
                 */
					if ($status_title == "APPLICATION")
					{
						echo '<div class ="col-md-12">';
                            ...
                            echo "\n<form>\n";
                            echo '<button type="submit" class="btn btn-primary" formaction="'.base_url().'index.php/adminTemporalModificationController/set/2">Move Forward to Selection &raquo</button>';
                            echo "\n<form>";
						echo '</div>';
					}// end application if
					else if ($status_title == "SELECTION")
					{
						echo '<div class ="col-md-6">';
							...
							echo '</p>';
							echo "\n<form>\n\t\t";
                            echo '<button type="submit" class="btn btn-danger" formaction="'.base_url().'index.php/adminTemporalModificationController/set/1">&laquo Move Back to Application</button>';
                            echo "\n</form>";
						echo '</div>';
						echo '<div class ="col-md-6">';
							echo '<p>';
							...
							echo '</p>';
                            echo "\n<form>\n\t\t";
                            echo '<button type="submit" class="btn btn-primary" formaction="'.base_url().'index.php/adminTemporalModificationController/set/3">Move Forward to Notification &raquo</button>';
                            echo "\n</form>";
						echo '</div>';
					...
					else if ($status_title == "NOTIFICATION")
					{
						echo '<div class ="col-md-6">';
							...
							echo '</p>';
                            echo "\n<form>\n";
                            echo '<button type="submit" class="btn btn-danger" formaction="'.base_url().'index.php/adminTemporalModificationController/set/2">&laquo Move Back to Selection</button>';
                            echo "\n</form>";
						echo '</div>';
						echo '<div class ="col-md-6">';
							echo '<p>';
