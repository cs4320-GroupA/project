				...
				echo'<div class="container text-center">';
			    	echo'<div class="row">';
				        ...
				        echo'<div class="col-md-6">';
				            ...
				            echo '<a class = "btn btn-default" id="info" href="'.base_url().'index.php/notifcationsController">Application <span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span></a>';
				        echo'</div>';
				    echo'</div>';
				echo'</div>';
			}
				...
				echo'<div class="container text-center">';
			    	echo'<div class="row">';
				        ...
				        echo'<img class="img-circle" width = "140" height = "140" id="thumbnail" src="../../img/lecturehall.jpg"">';
				            ...
				            echo '<a class = "btn btn-default" id="info" href="'.base_url().'index.php/instructorAddCourseController">Add Courses <span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span></a>';
				        echo'</div>';
				        echo'<div class="col-md-4">';
				        echo'<img class="img-circle" width = "140" height = "140" id="thumbnail" src="../../img/equation.jpg"">';
				            ...
				            echo '<a class = "btn btn-default" id="info" href="'.base_url().'index.php/instructorViewCoursesController">Your Courses <span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span></a>';
				        echo'</div>';
				        echo'<div class="col-md-4">';
				        echo'<img class="img-circle" width = "140" height = "140" id="thumbnail" src="../../img/applicantpool.jpg"">';
				            ...
				            echo '<a class = "btn btn-default" id="info" href="'.base_url().'index.php/applicantPoolController">Applicant Pool <span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span></a>';
				        echo'</div>';
				    echo'</div>';
				echo'</div>';
			}
				...
				echo'<div class="container text-center">';
			    	echo'<div class="row">';
				        ...
				        echo'<img class="img-circle" width = "140" height = "140" id="thumbnail" src="../../img/mouse.jpg"">';
				            ...
				            echo '<a class = "btn btn-default" id="info" href="'.base_url().'index.php/adminModifyCourseController">Modify Course <span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span></a>';
				        echo'</div>';
				        echo'<div class="col-md-3">';
				        echo'<img class="img-circle" width = "140" height = "140" id="thumbnail" src="../../img/assign.jpg"">';
				            ...
				            echo '<a class = "btn btn-default" id="info" href="'.base_url().'index.php/adminAssignApplicantController">Assign Applicants <span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span></a>';
				        echo'</div>';
				        echo'<div class="col-md-3">';
				        echo'<img class="img-circle" width = "140" height = "140" id="thumbnail" src="../../img/accountcreation.jpg"">';
				            ...
				            echo '<a class = "btn btn-default" id="info" href="'.base_url().'index.php/adminAccountCreationController">Account Creation <span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span></a>';
				        echo'</div>';
				      	echo'<div class="col-md-3">';
				      	echo'<img class="img-circle" width = "140" height = "140" id="thumbnail" src="../../img/timeline.jpg"">';
				            ...
				            echo '<a class = "btn btn-default" id="info" href="'.base_url().'index.php/adminTemporalModificationController">Change Timeline <span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span></a>';
				        echo'</div>';
				    echo'</div>';
				echo'</div>';
			}
