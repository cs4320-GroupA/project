				...
				echo'<div class="container text-center">';
			    	echo'<div class="row">';
				        ...
				        echo'<img class="img-circle" src="http://placehold.it/140x140">';
				            ...
				            echo '<a class = "btn btn-default" href="'.base_url().'index.php/form">Application &raquo</a>';
				        echo'</div>';
				    echo'</div>';
				echo'</div>';
			}
				...
				echo'<div class="container text-center">';
			    	echo'<div class="row">';
				        ...
				        echo'<img class="img-circle" src="http://placehold.it/140x140">';
				            ...
				            echo '<a class = "btn btn-default" href="'.base_url().'index.php/instructorAddCourseController">Add Courses &raquo</a>';
				        echo'</div>';
				        echo'<div class="col-md-4">';
				        echo'<img class="img-circle" src="http://placehold.it/140x140">';
				            ...
				            echo '<a class = "btn btn-default" href="'.base_url().'index.php/instructorViewCoursesController">Your Courses &raquo</a>';
				        echo'</div>';
				        echo'<div class="col-md-4">';
				        echo'<img class="img-circle" src="http://placehold.it/140x140">';
				            ...
				            echo '<a class = "btn btn-default" href="'.base_url().'index.php/applicantPoolController">Applicant Pool &raquo</a>';
				        echo'</div>';
				    echo'</div>';
				echo'</div>';
			}
				...
				echo'<div class="container text-center">';
			    	echo'<div class="row">';
				        ...
				        echo'<img class="img-circle" src="http://placehold.it/140x140">';
				            ...
				            echo '<a class = "btn btn-default" href="'.base_url().'index.php/adminModifyCourseController">Modify Course &raquo</a>';
				        echo'</div>';
				        echo'<div class="col-md-3">';
				        echo'<img class="img-circle" src="http://placehold.it/140x140">';
				             echo'<h3>Assign Applicants</h3>';
								echo'<p>Assign applicants to instructor courses -- consider preferences & comments.</p>';
				            echo '<a class = "btn btn-default" href="'.base_url().'index.php/adminAssignApplicantController">Assign Applicants &raquo</a>';
				        echo'</div>';
				        echo'<div class="col-md-3">';
				        echo'<img class="img-circle" src="http://placehold.it/140x140">';
				             echo'<h3>Account Creation</h3>';
								echo'<p>Add another admin account. Do so with extreme caution.</p>';
				            echo '<a class = "btn btn-default" href="'.base_url().'index.php/adminAccountCreationController">Account Creation &raquo</a>';
				        echo'</div>';
				      	echo'<div class="col-md-3">';
				      	echo'<img class="img-circle" src="http://placehold.it/140x140">';
				             echo'<h3>Change Timeline</h3>';
								echo'<p>Move the timeline of the application either forwards or backwards.</p>';
				            echo '<a class = "btn btn-default" href="'.base_url().'index.php/adminTemporalModificationController">Change Timeline &raquo</a>';
				        echo'</div>';
				    echo'</div>';
				echo'</div>';
			}
