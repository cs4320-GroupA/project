			...
			if($this->session->userdata('user_type') == 'applicant')
			{
				echo'<div class="container text-center">';
			    	echo'<div class="row">';
				        ...
				        echo'<img class="img-circle" width = "140" height = "140" src="../../img/application.jpg">';
			...
			else if($this->session->userdata('user_type') == 'instructor')
			{
				echo'<div class="container text-center">';
			    	echo'<div class="row">';
				        ...
				        echo'<img class="img-circle" width = "140" height = "140" src="../../img/lecturehall.jpg"">';
				        ...
				        echo'</div>';
				        echo'<div class="col-md-4">';
				        echo'<img class="img-circle" width = "140" height = "140" src="../../img/equation.jpg"">';
				        ...
				        echo'</div>';
				        echo'<div class="col-md-4">';
				        echo'<img class="img-circle" width = "140" height = "140" src="../../img/applicantpool.jpg"">';
			...
			else if($this->session->userdata('user_type') == 'admin')
			{
				echo'<div class="container text-center">';
			    	echo'<div class="row">';
				        ...
				        echo'<img class="img-circle" width = "140" height = "140" src="../../img/mouse.jpg"">';
				        ...
				        echo'</div>';
				        echo'<div class="col-md-3">';
				        echo'<img class="img-circle" width = "140" height = "140" src="../../img/assign.jpg"">';
				        ...
				        echo'</div>';
				        echo'<div class="col-md-3">';
				        echo'<img class="img-circle" width = "140" height = "140" src="../../img/accountcreation.jpg"">';
				        ...
				        echo'</div>';
				      	echo'<div class="col-md-3">';
				      	echo'<img class="img-circle" width = "140" height = "140" src="../../img/timeline.jpg"">';
