				...
				echo'<div class="container text-center">';
			    	echo'<div class="row">';
				        ...
				        echo'<img class="img-circle" src="http://placehold.it/140x140">';
				            ...
				            echo '<a class = "btn btn-default" href="'.base_url().'index.php/instructorAddCourseController">Add Courses »</a>';
				        echo'</div>';
				        echo'<div class="col-md-4">';
				        echo'<img class="img-circle" src="http://placehold.it/140x140">';
				            ...
				            echo '<a class = "btn btn-default" href="'.base_url().'index.php/instructorViewCoursesController">Your Courses »</a>';
				        echo'</div>';
				        echo'<div class="col-md-4">';
				        echo'<img class="img-circle" src="http://placehold.it/140x140">';
				            ...
				            echo '<a class = "btn btn-default" href="'.base_url().'index.php/applicantPoolController">Applicant Pool »</a>';
				        echo'</div>';
				    echo'</div>';
				echo'</div>';
			}
				...
				echo'<div class="container text-center">';
			    	echo'<div class="row">';
				        ...
				        echo'<img class="img-circle" src="http://placehold.it/140x140">';
				            ...
				            echo '<a class = "btn btn-default" href="'.base_url().'index.php/adminModifyCourseController">Modify Course »</a>';
				        echo'</div>';
				        echo'<div class="col-md-3">';
				        echo'<img class="img-circle" src="http://placehold.it/140x140">';
				        ...
				        echo'<img class="img-circle" src="http://placehold.it/140x140">';
				            ...
				            echo '<a class = "btn btn-default" href="'.base_url().'index.php/adminAccountCreationController">Account Creation »</a>';
				        echo'</div>';
				      	echo'<div class="col-md-3">';
				      	echo'<img class="img-circle" src="http://placehold.it/140x140">';
