                    	...
                    	<?php 
                    		if(isset($preferenced_forms)) {
                    			foreach($preferenced_forms as $row) {
									...
									echo '<td><form><button type="submit" class="btn btn-default message_panel" formaction="'.base_url().'/index.php/preferenceByCourseController/'.$course_id.'/'.$row->preference_id.'"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span> Remove</button></td>';
									echo '</tr>';
                    			}
                    		}
                    	?>
