...
<html lang="en">
  ...
  <body>
    ...
    <div class="modal fade bs-modal-md" id="register" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
              ...
              <form class="form-horizontal" action="<?php echo base_url(); ?>index.php/login/register" method="POST">
                ...
                <fieldset>
                  <div class="control-group">
                    <label class="control-label" for="pawprint">Pawprint:</label>
                    <div class="controls">
                      <input class="form-control" id="pawprint" name="pawprint" type="text" placeholder="abc123" required>
                    </div>
                  </div>
                  <div class="control-group">
                    <label class="control-label" for="passwordinput">Password:</label>
                    <div class="controls">
                      <input class="form-control" required="" id="passwordinput" name="passwordinput" type="password" placeholder="****" class="input-small">
                    </div>
                  </div>
                  <div class="controls">
